...
| [`doc/V1.1改进计划.md`](doc/V1.1改进计划.md) | V1.0 验收后的 5 项改进：错误反馈选中态、提示文案、状态栏、关卡显示 |
...
| **V1.1** | 已完成编码（待真机验收） | 5 项改进：错误后清空选中态、提示文案后到即替换并居中浅色半透明、边到边与状态栏自适应、HUD 显示当前关卡。`versionCode = 2` |
